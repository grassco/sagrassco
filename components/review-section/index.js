  ...
  return (
    <section className={styles.reviewSection}>
      <div className={styles.container}>
       <ReviewCard logo="/assets/marty.png" name="Marty Gavranovic" content="Awesome place, very good people to deal with,  great grass, and awesome prices!" />
       <ReviewCard
        logo="/assets/donna.png"
        name="Donna De Jesus"
